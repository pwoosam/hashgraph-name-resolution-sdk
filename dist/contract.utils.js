    ...
    try {
        ...
        switch (constants_config_1.NETWORK) {
            case 'testnet':
                ...
                url = `${constants_config_1.BASE_TEST_URL}/topics/${constants_config_1.MANAGER_TOPIC_ID}/messages/?limit=${constants_config_1.API_MAX_LIMIT}`;
                break;
            case 'mainnet':
                // eslint-disable-next-line max-len
                url = `${constants_config_1.BASE_MAIN_URL}/topics/${constants_config_1.MANAGER_TOPIC_ID}/messages/?limit=${constants_config_1.API_MAX_LIMIT}`;
                break;
            default:
...
const querySLDTopicMessages = async (topicId, sequenceNumber) => {
    try {
        ...
        switch (constants_config_1.NETWORK) {
            case 'testnet':
                // eslint-disable-next-line max-len
                url = `${constants_config_1.BASE_TEST_URL}/topics/${topicId}/messages/?sequenceNumber=gte:${sequenceNumber}&limit=${constants_config_1.API_MAX_LIMIT}`;
                break;
            case 'mainnet':
                // eslint-disable-next-line max-len
                url = `${constants_config_1.BASE_MAIN_URL}/topics/${topicId}/messages/?sequenceNumber=gte:${sequenceNumber}&limit=${constants_config_1.API_MAX_LIMIT}`;
                break;
            default:
                throw new Error('Invalid Network');
        }
...
const queryNFTOwner = async (serial, tokenId) => {
    try {
        ...
        switch (constants_config_1.NETWORK) {
            case 'testnet':
                url = `${constants_config_1.BASE_TEST_URL}/tokens/${tokenId.toString()}/nfts/${serial}`;
                break;
            case 'mainnet':
                url = `${constants_config_1.BASE_MAIN_URL}/tokens/${tokenId.toString()}/nfts/${serial}`;
                break;
            default:
                throw new Error('Invalid Network');
        }
